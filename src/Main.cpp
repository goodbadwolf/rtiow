...
int main(int argc, char *argv[]) {
  ...
  materials[0] = std::make_shared<Lambertian>(Vec3(0.1f, 0.2f, 0.5f));
  materials[1] = std::make_shared<Lambertian>(Vec3(0.8f, 0.8f, 0.0f));
  materials[2] = std::make_shared<Metal>(Vec3(0.8f, 0.6f, 0.2f), 0.0f);
  materials[3] = std::make_shared<Dielectric>(1.5f);
